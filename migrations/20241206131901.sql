...
CREATE TABLE "public"."debtor_transactions" (
  ...
  CONSTRAINT "fk_debtor_transactions_debtor" FOREIGN KEY ("debtor_id") REFERENCES "public"."debtors" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE "public"."debtor_installments" (
  ...
  "debtor_transaction_id" uuid NULL,
  "debtor_id" uuid NULL,
  PRIMARY KEY ("id"),
  ...
  CONSTRAINT "fk_debtor_installments_debtor" FOREIGN KEY ("debtor_id") REFERENCES "public"."debtors" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE "public"."debtor_tenor_limits" (
  ...
  CONSTRAINT "fk_debtor_tenor_limits_debtor" FOREIGN KEY ("debtor_id") REFERENCES "public"."debtors" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
...
-- Create "debtor_to_users" table
CREATE TABLE "public"."debtor_to_users" (
  "debtor_id" uuid NULL,
  "user_id" uuid NULL,
  CONSTRAINT "fk_debtor_to_users_debtor" FOREIGN KEY ("debtor_id") REFERENCES "public"."debtors" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT "fk_debtor_to_users_user" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
